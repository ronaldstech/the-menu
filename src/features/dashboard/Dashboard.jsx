...
function Dashboard({ user, token, onLogout, onPhoneVerified, createRestaurant, listRestaurants, getRestaurant, updateRestaurant, deleteRestaurant, listCategories, getCategory, createCategory, updateCategory, deleteCategory, listMenus, getMenu, createMenu, updateMenu, deleteMenu, listMenuItems, getMenuItem, createMenuItem, updateMenuItem, deleteMenuItem, listTables, getTable, createTable, updateTable, deleteTable, listStaff, getStaff, createStaff, updateStaff, deleteStaff, sendPhoneOtp, verifyPhoneOtp }) {
