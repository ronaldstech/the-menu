...
function PhoneVerification({ email, phone, verifyRegistrationCode, onVerified, onBack }) {
  ...
  return (
    <main className="auth-verification-page">
      ...
      <section className="auth-verification-content">
        ...
        <p className="auth-verification-copy">We sent a verification code to <strong>{phone || 'your phone number'}</strong>.</p>
        ...
        <button className="auth-verification-back" type="button" onClick={onBack}>Back to sign up</button>
      </section>
    </main>
  )
}
