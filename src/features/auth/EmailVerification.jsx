...
function EmailVerification({ email, verifyEmailCode, onVerified, onBack }) {
  ...
  return (
    <main className="auth-verification-page">
      ...
      <section className="auth-verification-content">
        ...
        <p className="auth-verification-copy">We sent a verification code to the phone number connected to <strong>{email}</strong>.</p>
